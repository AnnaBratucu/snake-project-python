...
def play_game(snake_head, snake_position, apple_position, button_direction, apple, edi, score):
    ...
    while crashed is not True:
        ...
        print(format(word["transcription"]))
        #if event.type == pygame.QUIT:
            #crashed = True
        #if event.type == pygame.KEYDOWN:
        if word["transcription"]== "left":
            button_direction = 0
        elif format(word["transcription"]) == "right":
            button_direction = 1
        elif format(word["transcription"]) == "upside":
            button_direction = 3
        elif format(word["transcription"]) == "down":
            button_direction = 2
        else:
